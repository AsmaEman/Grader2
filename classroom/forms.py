...
from classroom.models import ResultSheet,User,Teacher,Student,Grader,StudentMarks,StudentGrades,MessageToTeacher,ClassNotice,ClassAssignment,SubmitAssignment
from django.db import transaction
from .models import Terms

class TermsData(forms.Form):
	class meta:
		model = Terms
		fields = '__all__'
...
class GraderProfileForm(forms.ModelForm):
    class Meta():
        model =  Grader
        fields = ['name','subject_name','phone','email']
        widgets = {
...
class GraderProfileUpdateForm(forms.ModelForm):
    class Meta():
        model = Grader
        fields = ['name','subject_name','email','phone','grader_profile_pic']
...
class MarksForm(forms.ModelForm):
    class Meta():
        model = StudentMarks
        fields = ['subject_name','marks_obtained','maximum_marks','grades_obtained']
class GradesForm(forms.ModelForm):
    class Meta():
        model = StudentGrades
        fields = ['subject_name','grades_obtained']
...
class ResultSheetForm(forms.ModelForm):
    class Meta():
        model = ResultSheet
        fields = ['sheet_name','result_sheet']